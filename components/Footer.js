      ...
      <div className="section-padding py-16">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            >
              <span className="gradient-text">ModernLanding</span>
            </motion.div>
            <p className="text-gray-400 mb-6">
              Create beautiful, responsive websites with stunning animations and modern design principles.
            </p>
            <div className="flex space-x-4">
              <motion.a 
                ...
                className="bg-gray-800 hover:bg-violet-600 w-10 h-10 rounded-full flex items-center justify-center text-gray-300 hover:text-white transition-all duration-300"
                whileHover={{ y: -3 }}
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Web Design</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} ModernLanding. All rights reserved.
            </p>
